...
double-quote characters (``"``). This behavior is intended, and is part of our
...
- Apply your syntax analyzer to the supplied test programs, then use the
  ...
  supplied .xml compare files (note that the T.xml are *only* for the
  previous stage, and not for this one).
